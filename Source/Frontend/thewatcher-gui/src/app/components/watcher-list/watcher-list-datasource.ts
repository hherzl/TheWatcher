...
import { WatcherItemModel } from 'src/app/services/panel-client.service';
...
// const EXAMPLE_DATA: WatcherListItem[] = [
//   {id: 1, name: 'Hydrogen'},
//   {id: 2, name: 'Helium'},
//   {id: 3, name: 'Lithium'},
//   {id: 4, name: 'Beryllium'},
...
/**
 * Data source for the WatcherList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class WatcherListDataSource extends DataSource<WatcherItemModel> {
